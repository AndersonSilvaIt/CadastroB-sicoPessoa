namespace CadastroPessoa.Formularios {
	partial class FormListFuncionario {
		/// <summary>
		...
		private void InitializeComponent() {
			...
			this.gridFuncionario.Location = new System.Drawing.Point(25, 103);
			...
			this.gridFuncionario.ShowCellErrors = false;
			this.gridFuncionario.ShowCellToolTips = false;
			this.gridFuncionario.ShowEditingIcon = false;
			this.gridFuncionario.ShowRowErrors = false;
			this.gridFuncionario.Size = new System.Drawing.Size(666, 150);
			this.gridFuncionario.TabIndex = 0;
			this.gridFuncionario.VirtualMode = true;
			// 
			// btnAdd
			// 
			...
			// btnEditar
			// 
			this.btnEditar.Location = new System.Drawing.Point(535, 259);
			...
			// btnExcluir
			// 
			this.btnExcluir.Location = new System.Drawing.Point(616, 259);
			...
			this.Name = "FormListFuncionario";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "FormListFuncionario";
